...
# GPIO pin setup for motor 1 PWM
GPIO.setup(IN1, GPIO.OUT)
GPIO.setup(IN2, GPIO.OUT)
GPIO.setup(ENA, GPIO.OUT)

# GPIO pin setup for motor 2 PWM
GPIO.setup(IN3, GPIO.OUT)
GPIO.setup(IN4, GPIO.OUT)
GPIO.setup(ENB, GPIO.OUT)

# GPIO pin setup for motor 3 PWM
GPIO.setup(IN5, GPIO.OUT)
GPIO.setup(IN6, GPIO.OUT)
GPIO.setup(ENC, GPIO.OUT)

# GPIO pin setup for motor 4 PWM
GPIO.setup(IN7, GPIO.OUT)
GPIO.setup(IN8, GPIO.OUT)
GPIO.setup(END, GPIO.OUT)

# GPIO pin setup for motor 5
GPIO.setup(IN9, GPIO.OUT)
GPIO.setup(IN10, GPIO.OUT)
GPIO.setup(ENE, GPIO.OUT)

# GPIO pin setup for motor 6
